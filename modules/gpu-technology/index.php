<?php
/*
 * Qualcomm HTML5 Modules : GPU Technology
 */
$v = '0.1.1';
$qv = '?v='. $v;
?>
...
<body>
    ...
    <div class="scene scene--11 panel-snap" data-scene="11">
		...
		<div class="vidhere">
			<video id="magevid" poster="img/magevstroll.jpg" width="960" height="540" title="Tire out your games - not your battery" data-uid="magevid" data-autoresize="fit" preload="none">
			  <source src="video/Mage30.mp4" />
			  <source src="video/Mage30.webm" />
			</video>
		</div>
    </div>
